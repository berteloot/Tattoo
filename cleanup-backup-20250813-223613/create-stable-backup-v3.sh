...
echo "🎨 Creating Stable Backup v3 of Tattoo Artist Locator App..."
echo "=================================================="

# Create backup directory with timestamp
BACKUP_DIR="stable-backup-v3-$(date +%Y%m%d-%H%M%S)"
mkdir -p "$BACKUP_DIR"
...
copy_file_with_progress ".env.example" "$BACKUP_DIR" "Environment template"
...
copy_file_with_progress "emergency-account-recovery.js" "$BACKUP_DIR/scripts" "Emergency recovery"
copy_file_with_progress "reset-stan-password.js" "$BACKUP_DIR/scripts" "Password reset script"
copy_file_with_progress "reset-stan-password-production.js" "$BACKUP_DIR/scripts" "Production password reset"
copy_file_with_progress "reset-stan-password-via-api.js" "$BACKUP_DIR/scripts" "API password reset"
copy_file_with_progress "production-quick-fix.js" "$BACKUP_DIR/scripts" "Production quick fix"
copy_file_with_progress "quick-fix-disable-verification.js" "$BACKUP_DIR/scripts" "Verification disable fix"
copy_file_with_progress "render-database-recovery.js" "$BACKUP_DIR/scripts" "Database recovery"
copy_file_with_progress "add-profile-picture-fields-production.js" "$BACKUP_DIR/scripts" "Profile picture fields"
copy_file_with_progress "add-studio-coordinates.js" "$BACKUP_DIR/scripts" "Studio coordinates"
copy_file_with_progress "create-studio-views.js" "$BACKUP_DIR/scripts" "Studio views"
copy_file_with_progress "emergency-account-recovery.js" "$BACKUP_DIR/scripts" "Emergency recovery"
copy_file_with_progress "fix-favorites-schema.js" "$BACKUP_DIR/scripts" "Favorites schema fix"
copy_file_with_progress "fix-paris-studios-data.js" "$BACKUP_DIR/scripts" "Paris studios data fix"
copy_file_with_progress "fix-production-paris-data-sql.sql" "$BACKUP_DIR/scripts" "Production Paris data SQL"
...
copy_file_with_progress "test-geocoding-endpoint.js" "$BACKUP_DIR/scripts" "Geocoding test"
...
# 8. Create environment template backup
echo ""
echo "🔐 Creating environment template backup..."
...
# 9. Create database schema backup
echo ""
...
# 13. Final summary
echo ""
echo "🎉 STABLE BACKUP v3 COMPLETED SUCCESSFULLY!"
echo "=================================================="
