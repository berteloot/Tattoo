...
async function addStudioCoordinates() {
  try {
    console.log('🔍 Fetching studios without coordinates...');
    
    // Get studios that don't have coordinates
    const studios = await prisma.studio.findMany({
      ...
      take: 10 // Limit to first 10 studios
    });
