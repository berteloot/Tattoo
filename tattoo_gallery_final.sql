...
INSERT INTO specialties (id, name, category, description, "isActive", "updatedAt") VALUES
    (gen_random_uuid()::text, 'Traditional American', 'Tattoo Style', 'Classic American traditional tattoos with bold outlines and limited color palette', true, NOW()),
    (gen_random_uuid()::text, 'Japanese (Irezumi)', 'Tattoo Style', 'Traditional Japanese tattoo art with detailed designs and vibrant colors', true, NOW()),
    (gen_random_uuid()::text, 'Black & Grey', 'Tattoo Style', 'Monochrome tattoos using only black and grey ink', true, NOW()),
    (gen_random_uuid()::text, 'Realistic', 'Tattoo Style', 'Photorealistic tattoos that look like photographs', true, NOW()),
    (gen_random_uuid()::text, 'Neo-Traditional', 'Tattoo Style', 'Modern take on traditional American style with more detail and color', true, NOW()),
    (gen_random_uuid()::text, 'Watercolor', 'Tattoo Style', 'Soft, painterly style that mimics watercolor paintings', true, NOW()),
    (gen_random_uuid()::text, 'Geometric', 'Tattoo Style', 'Clean lines and geometric shapes', true, NOW()),
    (gen_random_uuid()::text, 'Minimalist', 'Tattoo Style', 'Simple, clean designs with minimal detail', true, NOW()),
    (gen_random_uuid()::text, 'Tribal', 'Tattoo Style', 'Traditional tribal patterns and designs', true, NOW()),
    (gen_random_uuid()::text, 'New School', 'Tattoo Style', 'Cartoon-like style with bold colors and exaggerated features', true, NOW())
