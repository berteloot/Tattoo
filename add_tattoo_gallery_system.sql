-- Tattoo Gallery System - Best Practices Implementation
-- This script adds a comprehensive tattoo gallery system for artist portfolios
...
CREATE TABLE IF NOT EXISTS tattoo_gallery (
    ...
    tattoo_style VARCHAR(100), -- Traditional, Japanese, Black & Grey, etc.
    body_location VARCHAR(100), -- Arm, Leg, Back, Chest, etc.
    tattoo_size VARCHAR(50), -- Small, Medium, Large, Full Sleeve, etc.
    color_type VARCHAR(50), -- Color, Black & Grey, Blackwork, etc.
    session_count INTEGER DEFAULT 1, -- Number of sessions to complete
    hours_spent INTEGER, -- Total hours spent on this piece
...
-- GRANT SELECT, INSERT, UPDATE, DELETE ON tattoo_gallery TO your_app_user;
-- GRANT SELECT, INSERT, UPDATE, DELETE ON tattoo_gallery_likes TO your_app_user;
-- GRANT SELECT, INSERT, UPDATE, DELETE ON tattoo_gallery_comments TO your_app_user;
-- GRANT SELECT, INSERT ON tattoo_gallery_views TO your_app_user;
...
-- Success message
SELECT 'Tattoo Gallery System successfully created with all tables, indexes, views, and functions!' as status; 