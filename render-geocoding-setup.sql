-- =====================================================
-- RENDER PRODUCTION GEOCODING SETUP
...
-- 4. Show current geocoding status
SELECT 
    ...
    ROUND(
        (COUNT(CASE WHEN latitude IS NOT NULL AND longitude IS NOT NULL THEN 1 END)::float / COUNT(*)) * 100, 
        2
